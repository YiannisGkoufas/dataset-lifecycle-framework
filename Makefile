...
undeployment:
	kubectl delete -n $(DATASET_OPERATOR_NAMESPACE) clusterrole,clusterrolebinding,ds,deploy,job,mutatingwebhookconfiguration,role,rolebinding,svc,sa,statefulset,storageclass -l app.kubernetes.io/name=dlf
